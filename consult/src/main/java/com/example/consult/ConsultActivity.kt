...
import com.example.consult.databinding.ActivityConsultBinding
...
class ConsultActivity : BaseActivity<ActivityConsultBinding>(), MainConstValue {
    ...
    private fun init() {
        frame = frame_consult
        tabLayout = tb_layout_consult
        initTabLayout()
        initFragment()
    }

    private fun initFragment() {
        supportFragmentManager.beginTransaction().add(R.id.frame_consult, ConsultFragment()).commit()
    }
